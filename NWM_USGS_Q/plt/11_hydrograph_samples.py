...
for site_id in site_ids:
    ...
    ax[0,i].set_title('USGS ID: {} (Basin: {})\n{}'.format(site_id,Basin,condition_str))
    ...
    ax[0,i].text(0.5,1.3,'({})'.format(chr(97+i)),transform=ax[0,i].transAxes,fontsize=14,ha='center',weight='bold')
